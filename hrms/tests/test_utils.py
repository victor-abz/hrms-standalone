...
from hrms.setup.doctype.department.department import get_abbreviated_name
from hrms.setup.doctype.designation.test_designation import create_designation
from hrms.setup.utils import enable_all_roles_and_domains
...
def create_department(name: str, company: str = "_Test Company") -> str:
    ...
    department.update(
        {"doctype": "Department", "department_name": name, "company": "_Test Company"}
    )
    department.insert()
