...
class TestEmployeeReminders(FrappeTestCase):
    ...
    def setUpClass(cls):
        super().setUpClass()
        from hrms.setup.doctype.holiday_list.test_holiday_list import make_holiday_list
    ...
    def test_is_holiday(self):
        ...
        self.assertFalse(
            is_holiday(
                self.test_employee.name, date=self.test_holiday_dates[2], only_non_weekly=True
            )
        )
