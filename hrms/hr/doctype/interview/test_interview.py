...
class TestInterview(FrappeTestCase):
    ...
    def test_notification_for_scheduling(self):
        ...
        interview = create_interview_and_dependencies(
            job_applicant.name, scheduled_on=scheduled_on
        )
    ...
    def test_skill_wise_average_rating(self):
        from hrms.hr.doctype.interview_feedback.test_interview_feedback import (
        ...
        self.assertEqual(
            ratings, [{"skill": "Python", "rating": 0.75}, {"skill": "JS", "rating": 0.85}]
        )
