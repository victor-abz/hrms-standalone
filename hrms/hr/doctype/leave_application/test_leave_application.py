...
class TestLeaveApplication(FrappeTestCase):
    ...
    def test_attendance_for_include_holidays(self):
        ...
        self.assertEqual(
            frappe.db.count("Attendance", {"leave_application": leave_application.name}), 4
        )
    ...
    def test_optional_leave(self):
        ...
        frappe.db.set_value(
            "Leave Period", leave_period.name, "optional_holiday_list", holiday_list
        )
    ...
    def test_leave_details_with_expired_cf_leaves(self):
        ...
        self.assertEqual(
            leave_details["leave_allocation"][leave_type.name]["remaining_leaves"], 30.0
        )
    ...
    def test_get_leave_allocation_records(self):
        ...
        details = get_leave_allocation_records(
            employee.name, add_days(cf_expiry, -1), leave_type.name
        )
        expected_data = {
