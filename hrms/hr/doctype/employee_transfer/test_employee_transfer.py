...
class TestEmployeeTransfer(FrappeTestCase):
        ...
        transfer_obj = frappe.get_doc(
            {
                ...
                "employee": frappe.get_value(
                    "Employee", {"user_id": "employee2@transfers.com"}, "name"
                ),
                "transfer_details": [
                    {
    ...
    def test_new_employee_creation(self):
        ...
        transfer = frappe.get_doc(
            {
                "doctype": "Employee Transfer",
                "employee": frappe.get_value(
                    "Employee", {"user_id": "employee3@transfers.com"}, "name"
                ),
        ...
        self.assertEqual(
            frappe.get_value("Employee", transfer.new_employee_id, "status"), "Active"
        )
