...
class EmployeeAdvance(Document):
    ...
    #     if flt(return_amount) > 0 and flt(return_amount) > (
    #         self.paid_amount - self.claimed_amount
    #     ):
...
def make_bank_entry(dt, dn):
    ...
    advance_account_currency = frappe.db.get_value(
        "Account", doc.advance_account, "account_currency"
    )
