...
frappe.ui.form.on('Employee Advance', {
  ...
  refresh: function (frm) {
    if (
      ...
      flt(frm.doc.claimed_amount) <
        flt(frm.doc.paid_amount) - flt(frm.doc.return_amount) &&
  ...
  make_deduction_via_additional_salary: function (frm) {
    frappe.call({
      method:
        'hrms.hr.doctype.employee_advance.employee_advance.create_return_through_additional_salary',
      args: {
        doc: frm.doc,
      },
      callback: function (r) {
  ...
  get_pending_amount: function (frm) {
    frappe.call({
      method:
        'hrms.hr.doctype.employee_advance.employee_advance.get_pending_amount',
      args: {
        employee: frm.doc.employee,
        posting_date: frm.doc.posting_date,
      },
  ...
  get_employee_currency: function (frm) {
    frappe.call({
      method:
        'hrms.payroll.doctype.salary_structure_assignment.salary_structure_assignment.get_employee_currency',
      args: {
        employee: frm.doc.employee,
      },
      callback: function (r) {
