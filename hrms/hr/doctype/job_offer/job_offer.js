...
frappe.ui.form.on('Job Offer', {
  ...
  select_terms: function (frm) {
    hrms.utils.get_terms(frm.doc.select_terms, frm.doc, function (r) {
      if (!r.exc) {
  ...
  refresh: function (frm) {
    if (
      ...
      frm.add_custom_button(__('Create Employee'), function () {
        hrms.job_offer.make_employee(frm);
      });
    }
...
hrms.job_offer.make_employee = function (frm) {
