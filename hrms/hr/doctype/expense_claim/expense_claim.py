...
class ExpenseClaim(Document):
    ...
    #                 (
    #                     self.docstatus == 1
    #                     and flt(self.grand_total, precision)
    ...
    #         # payment entry
    #         payment_account = get_bank_cash_account(self.mode_of_payment, self.company).get(
    #             "account"
    #         )
    #         gl_entry.append(
    #             self.get_gl_dict(
    ...
    #             frappe.throw(
    #                 _("Mode of payment is required to make a payment").format(self.employee)
    #             )
    ...
    #             frappe.throw(
    #                 _("Total advance amount cannot be greater than total sanctioned amount")
    #             )
...
def update_reimbursed_amount(doc):
    ...
    frappe.db.set_value(
        "Expense Claim", doc.name, "total_amount_reimbursed", total_amount_reimbursed
    )
