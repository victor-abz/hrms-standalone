...
frappe.ui.form.on('Expense Claim', {
  ...
  //     frappe.call({
  //       method:
  //         'hrms.hr.doctype.expense_claim.expense_claim.get_expense_claim_account_and_cost_center',
  //       args: {
...
//       if (
//         cint(doc.total_amount_reimbursed) > 0 &&
...
//             'status',
//             'not in',
//             ['Claimed', 'Returned', 'Partly Claimed and Returned'],
//           ],
//         ],
//       };
//     });
...
//       return frappe.call({
//         method:
//           'hrms.hr.doctype.leave_application.leave_application.get_mandatory_approval',
//         args: {
//           doctype: frm.doc.doctype,
//         },
//         callback: function (r) {
...
//       child.description = child.account_head
//         .split(' - ')
//         .slice(0, -1)
//         .join(' - ');
//       refresh_field('taxes');
...
//     if (!child.amount) {
//       child.tax_amount =
//         flt(frm.doc.total_sanctioned_amount) * (flt(child.rate) / 100);
//     }
