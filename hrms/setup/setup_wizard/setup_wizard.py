...
from hrms.setup.demo import setup_demo_data
from hrms.setup.setup_wizard.operations import install_fixtures as fixtures
    ...
    if frappe.db.sql("select name from tabCompany"):
        ...
        stages = [
            ...
            },
            {
                ...
                "tasks": [
                    {"fn": setup_company, "args": args, "fail_msg": _("Failed to setup company")}
                ],
            },
            {
