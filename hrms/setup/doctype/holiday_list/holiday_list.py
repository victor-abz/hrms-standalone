...
class HolidayList(Document):
    ...
    if TYPE_CHECKING:
        ...
        from hrms.setup.doctype.holiday.holiday import Holiday
    ...
    def get_weekly_off_dates(self):
        ...
        for d in self.get_weekly_off_date_list(self.from_date, self.to_date):
            ...
            self.append(
                "holidays", {"description": _(self.weekly_off), "holiday_date": d, "weekly_off": 1}
            )
    ...
    def get_local_holidays(self):
        ...
        for holiday_date, holiday_name in country_holidays(
            ...
            self.append(
                "holidays",
                {"description": holiday_name, "holiday_date": holiday_date, "weekly_off": 0},
            )
