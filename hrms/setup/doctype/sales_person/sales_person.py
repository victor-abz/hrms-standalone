...
class SalesPerson(NestedSet):
    ...
    if TYPE_CHECKING:
        ...
        from hrms.setup.doctype.target_detail.target_detail import TargetDetail
...
def get_timeline_data(doctype: str, name: str) -> dict[int, int]:
    ...
    for ts, count in chain(
        sales_order_activity.items(),
        sales_invoice_activity.items(),
        delivery_note_activity.items(),
    ):
